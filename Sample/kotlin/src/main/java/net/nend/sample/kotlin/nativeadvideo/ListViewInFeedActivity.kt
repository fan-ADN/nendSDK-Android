...
class ListViewInFeedActivity : ListActivity() {
    ...
    internal inner class NativeListAdapter(context: Context, resource: Int, list: List<String>) : ArrayAdapter<String>(context, resource, list) {
        ...
        private val videoLoader = NendAdNativeVideoLoader(
                context,
        ...
        override fun getView(position: Int, view: View?, parent: ViewGroup): View {
            ...
            when (getItemViewType(position)) {
                ViewType.AD.id -> {
                    ...
                    if (convertView == null) {
                        convertView = LayoutInflater.from(context).inflate(R.layout.native_video_ad_row_for_list, parent, false)!!
                    ...
                    if (convertView == null) {
                        convertView = LayoutInflater.from(context).inflate(R.layout.native_list_row, parent, false)!!
                        holder = ViewHolder()
